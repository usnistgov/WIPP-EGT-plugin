//
// Created by gerardin on 9/25/19.
//

#ifndef NEWEGT_EFFICIENTAABBTREE_H
#define NEWEGT_EFFICIENTAABBTREE_H


//
// Created by gerardin on 8/6/19.
//

#ifndef NEWEGT_AABBTREE_H
#define NEWEGT_AABBTREE_H
...
#include <FastImage/FeatureCollection/tools/Cuboid.h>
...
///
    ...
    public:
        explicit EfficientAABBTree(objects_size_type maxNodeSize = 4);
...
///
    template<class ObjectT>
    EfficientAABBTree<ObjectT>::EfficientAABBTree(objects_size_type maxNodeSize)
    ...
    template<class ObjectT>
    EfficientAABBTree<ObjectT>::~EfficientAABBTree() = default;
...
///
    template<class ObjectT>
    void
    EfficientAABBTree<ObjectT>::preprocess(std::vector<ObjectT*> *objects) {
    ...
    template<class ObjectT>
    void
    EfficientAABBTree<ObjectT>::computeAABBBounds(aabbTree_size_type nodeIndex) {
    ...
    template<class ObjectT>
    void
    EfficientAABBTree<ObjectT>::splitAABBNode(aabbTree_size_type nodeIndex,
                                     int splitDim) {
...
///
    template<class ObjectT>
    std::vector<ObjectT *> EfficientAABBTree<ObjectT>::objectsContain(
...
#endif //NEWEGT_AABBTREE_H



#endif //NEWEGT_EFFICIENTAABBTREE_H
